...
(function() {
	...
	icons['mailwrapper'] = '<i class="fas fa-minus-square" title="Вставить оболочку содержимого"></i>';
	icons['preview'] = '<i class="fas fa-eye" title="Предпросмотр"></i>';
	icons['homelogo'] = '<i class="fas fa-hotel" title="Логотип компании"></i>';
})();